...
my $HELP = '
        ...
        Usage:
               perl  sc-5hmC-Seal_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time perl  sc-5hmC-Seal_1.pl    -in 1_rawFASTQ   > sc-5hmC-Seal_1.runLog.txt  2>&1  & 
...
## Version Infromation
my $version = "    The 1st Step, version 1.2,  2024-02-15.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  sc-5hmC-Seal_1.pl  -help' \n";
    exit 0;
}
